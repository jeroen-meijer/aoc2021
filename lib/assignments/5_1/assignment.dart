...
final assignment5_1 = Assignment<int>(
  id: 'Day 5 Part 1',
  name: 'Hydrothermal Venture - Part 1',
  answer: 7297,
  fn: _run,
);
...
int _run() {
  final data =
      getAssignmentData('5_1').map((line) => OffsetTween.parse(line)).toSet();

  final nonDiagonalInterpolatedTweens =
      data.where((t) => !t.isDiagonal).map((t) => t.interpolate()).toSet();
  final interpolatedOffsets =
      nonDiagonalInterpolatedTweens.expand((o) => o).toList();
